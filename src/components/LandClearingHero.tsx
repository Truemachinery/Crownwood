...
import { ArrowRight, Trees, Mountain, MapPin } from "lucide-react";

export function LandClearingHero() {
    ...
    return (
        <section ref={containerRef} className="relative pt-40 pb-24 px-6 md:px-12 lg:px-24 overflow-hidden bg-asphalt min-h-[90dvh] flex flex-col justify-center">
            <div className="absolute inset-0 z-0 service-bg">
                ...
                <img
                    src="/images/land-clearing-hero.png"
                    alt="Heavy machinery clearing land for construction"
            ...
            <div className="relative z-20 max-w-5xl">
                ...
                <h1 className="service-title font-heading font-bold text-5xl md:text-7xl lg:text-[6rem] text-concrete uppercase tracking-tight leading-[0.9] text-balance mb-8">
                    Heavy <span className="font-drama italic text-safety-amber">Land Clearing</span><br />& Demolition
                </h1>
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="service-stats flex items-center gap-3 text-concrete">
                            <Trees className="w-8 h-8 opacity-50" />
                            <div className="flex flex-col">
                                <span className="font-heading font-bold text-xl leading-none">ZERO</span>
                                <span className="font-mono text-[10px] text-concrete/50 tracking-widest">TIMBER LEFT BEHIND</span>
                            </div>
                        </div>
                        <div className="w-[1px] h-8 bg-white/10 service-stats"></div>
                        <div className="service-stats flex items-center gap-3 text-concrete">
                            <Mountain className="w-8 h-8 text-safety-amber" />
                            <div className="flex flex-col">
                                <span className="font-heading font-bold text-xl leading-none">LASER</span>
                                <span className="font-mono text-[10px] text-concrete/50 tracking-widest">GPS GRADING</span>
                            </div>
                        </div>
                    </div>
                </div>
