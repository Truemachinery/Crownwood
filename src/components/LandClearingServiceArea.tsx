...
export function LandClearingServiceArea() {
    const localBusinessSchema = {
        "@context": "https://schema.org",
        "@type": "ExcavatingContractor",
        "name": "Crownwood Chemicals - Land Clearing Division",
        "image": "https://new.tmlabz.com/images/land-clearing-hero.png",
        "description": "Heavy-duty land clearing, precision site grading, and commercial pad site preparation serving San Antonio, TX, and Bexar County.",
        "address": {
            "@type": "PostalAddress",
        ...
        <section className="py-24 px-6 md:px-12 lg:px-24 bg-white relative border-t border-black/5">
            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
                <div className="flex-1">
                    ...
                    <p className="font-sans text-xl text- औद्योगिक/70 leading-relaxed mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-10">
                        {['San Antonio', 'New Braunfels', 'Boerne', 'Spring Branch', 'Helotes', 'Bulverde'].map(city => (
                ...
                <div className="flex-1 relative w-full aspect-square md:aspect-video lg:aspect-square max-w-lg bg-concrete rounded-3xl overflow-hidden shadow-2xl border border-black/10">
                    <img
                        src="https://images.unsplash.com/photo-1508450859948-4e04fabaa4ea?q=80&w=2579&auto=format&fit=crop"
                        alt="Aerial map of San Antonio development site"
                    ...
                    <div className="absolute bottom-6 left-6 right-6 p-4 bg-white/90 backdrop-blur-md rounded-xl shadow-lg border border-black/5">
                        ...
                        <div className="font-heading font-bold text-lg text-industrial uppercase">San Antonio Earthworks</div>
                    </div>
                </div>
